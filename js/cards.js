const renderCards = (card) => {
  const markup = `
    <div class="min-w-[300px] h-[378px] max-w-[370px] max-h-[378px] py-10 px-12 bg-[#FFFFFF] rounded-3xl">
      ...
      <button class="text-base flex gap-2.5 items-center border-b-2 border-solid text-[#1B5B31] border-[#1B5B31]">
        ${card.link}
...
cardsArray.map((cardData) => {
  const cardHTML = renderCards(cardData);

  ...
  const content = [
    {
      ...
      imgSrcset:
        "/zadanie-rekrutacyjne/Photo.e147f6fd.jpg 1x, /zadanie-rekrutacyjne/Photo@2x.afe82740.jpg 2x",
    },
    {
      text: "Zielone piękno Twojego ogrodu",
      spanText:
        "Nasza firma zajmuje się profesjonalną aranżacją ogrodów, tworząc wyjątkowe przestrzenie pełne natury i harmonii.",
      imgSrcset:
        "/zadanie-rekrutacyjne/hero-garden.fa6a9902.jpg 1x, /zadanie-rekrutacyjne/hero-garden.fa6a9902.jpg 2x",
    },
    {
      text: "Twój raj na ziemi",
      spanText:
        "Stworzymy dla Ciebie wymarzony ogród, gdzie możesz odpocząć, cieszyć się pięknem roślin i spędzać czas na łonie natury.",
      imgSrcset:
        "/zadanie-rekrutacyjne/hero-garden-2.22fb90a1.jpg 1x, /zadanie-rekrutacyjne/hero-garden-2.22fb90a1.jpg 2x",
    },
  ];
